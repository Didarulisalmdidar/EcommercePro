   ...
   <body>
      ...
      <h1 style="font-size:30px;text-align:center;padding-top:30px;padding-bottom:20px">Comments</h1>
         <form action="{{url('add_comment')}}" method="POST">
            @csrf
         <textarea  placeholder="Comment Here" name="comment" style="height:150px;width:600px"></textarea>
         <br>
     <input type="submit" class="btn btn-primary" value="Comment">
      ...
      <input type="text" id="commentId" name="commentId" hidden="">
         ...
         <br>
        <button type="submit" calss="btn btn-warning">Reply</button>
     ...
     @include('home.client')
      ...
      <!-- footer end -->
      <div class="cpy_">
         <p class="mx-auto">All rights reserved by Authority <br>
