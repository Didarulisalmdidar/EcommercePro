<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                <x-label for="L-name" value="{{ __('Last Name') }}" />
                <x-input id="L-name" class="block mt-1 w-full" type="text" name="L-name" :value="old('L-name')" required autofocus autocomplete="L-name" />
            </div>
